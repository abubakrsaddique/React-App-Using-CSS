      ...
      <div className="about-sub-container">
        ...
        <div className="left-side">
          <div className="left-side-d">
            ...
            <div className="left-card">
              ...
              >
                <div className="left-card-sub">
                  ...
                  <div className="left-card-text-mr">
                    <h1 className="left-card-hd">Donec porttitor euismod</h1>
                    <p className="left-card-para">
            ...
            {/* {Second Card} */}
            <div className="left-card" style={{ marginTop: "-10%" }}>
              <div
                className="left-card-d "
                data-aos="fade-right"
                data-aos-duration="1000"
